...
begin
	kk = [i*100 for i in 0:Int(n/100)]
	perror = zeros(Int(n/100))
	for i = 1:Int(n/100)
...
# ╔═╡ 196c8ceb-3c82-48f5-830b-ff89102d32d1
begin
	scatter(kk, perror, xlabel="k", ylabel="L₂-norm of p error", title="L₂-norm of p error vs k")
	#xlims!(10, 10^4 + 100)
	#ylims!(0.2,0.8)
end


# ╔═╡ 50cc00f6-263c-44ca-bbaf-48613a758442
p_matrix[:, 1:15]

# ╔═╡ 8612dc5f-21e1-4559-9ecd-8dc018583c23
begin
	nn = [50, 100, 150, 200, 250, 300]
	regret = [3.578154192937115/ 9.135735297071426, 12.111179323510205/17.14210613204243,  15.317149003659171/29.488237824712186, 22.06680226012802/32.14786080455973, 23.68581488555933/43.37527584609548,  34.989392364474966/50.70861909013603]
	plot(nn, regret, ylabel="competitive raio", xlabel="n")
end
